...
### Data Display III: Matplotlib, Plotly ###
st.title('Data Display III: Matplotlib, Plotly')
...
# give me the location for Barcelona:
m = folium.Map(location=[41.3851, 2.1734], zoom_start=10)
folium.Marker([37.7749, -122.4194], popup="Barcelona").add_to(m)
folium_static(m)